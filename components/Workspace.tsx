      ...
      <div className="w-3/4 p-8">
        {selectedFile ? (
          <>
            ...
            <textarea
              className="w-full h-[calc(100vh-200px)] p-4 border border-gray-300 rounded-lg shadow-inner focus:outline-none focus:ring-2 focus:ring-primary resize-none transition duration-300"
              value={fileContent}
